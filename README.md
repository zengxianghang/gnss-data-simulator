...
Current V1 defaults include a 3 degree elevation mask, EPH+ION navigation output, no measurement-noise or multipath model, zero receiver clock bias/drift, and 8 hours of generated data per scenario unless overridden by configuration.

See:

- [`docs/DESIGN_SPEC.md`](docs/DESIGN_SPEC.md) for the agreed architecture and V1 scope.
- [`docs/ENGINEERING_RULES.md`](docs/ENGINEERING_RULES.md) for the frozen repository layout, file naming, C/C++ coding rules, GitHub Actions policy, and unit/integration test principles.
